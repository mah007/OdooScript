...
sudo -H pip3 install -r https://raw.githubusercontent.com/odoo/odoo/15.0/requirements.txt --user
sudo -H pip3 install -r https://raw.githubusercontent.com/mah007/OdooScript/14.0/requirements.txt --user
